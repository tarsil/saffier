...
declaring this simple **unique**. Via [saffier field](./fields.md) directly or via
...
[saffier field](./fields.md) an using the [meta](#the-meta-class) for only one field is overkill.
