...
For unique reverse relations, Saffier uses the singular model name instead. This applies to
`OneToOneField` and to unique many-to-many reverse accessors created from generated through models.
